...
$queryRapotSisipan = "SELECT m.id_mapel, m.mapel,
                    ...
                    while ($row = mysqli_fetch_array($query)) {
                        ...
                        $html  .= '<td style="width: 4.5%">' . $lm1tp1 . '</td>';
                        $html  .= '<td style="width: 4.5%">' . $lm1tp2 . '</td>';
                        $html  .= '<td style="width: 4.5%">' . $lm2tp1 . '</td>';
                        $html  .= '<td style="width: 4.5%">' . $lm2tp2 . '</td>';
                        $html  .= '<td style="width: 4.5%">' . $lm3tp1 . '</td>';
                        $html  .= '<td style="width: 4.5%">' . $lm3tp2 . '</td>';
                        $html  .= '<td style="width: 4.5%">' . $lm4tp1 . '</td>';
                        $html  .= '<td style="width: 4.5%">' . $lm4tp2 . '</td>';
