...
$html = '<div><table style="font-family: helvetica; font-size: 13px;"><tr><td style="width: 60%">
...
$queryRapotSisipan = "SELECT m.id_mapel, m.mapel,
                    ...
                    $html  .= '<table border="0.75" style="width: 100%; text-align: center; font-family: helvetica; font-size: 11px; ">';
                    $html  .= '<tr>';
                    $html  .= '<th rowspan="3" style="width: 4%; height: 30px; vertical-align: middle; font-weight: bold;"><br><br>No.</th>';
                    $html  .= '<th rowspan="3" style="width: 22%; height: 30px; text-align: left; font-weight: bold;"><br><br>Mata Pelajaran</th>';
                    $html  .= '<th colspan="8" style="line-height: 1.5; text-align: center; font-weight: bold;  width: 36%">FORMATIF</th>';
                    $html  .= '<th rowspan="2" colspan="4" style="line-height: 2; text-align: center;font-weight: bold; width: 18%">NSLM</th>';
                    $html  .= '<th rowspan="2" colspan="2" style="line-height: 2; font-weight: bold; width: 11%">NR</th>';
                    $html  .= '</tr>';
                    $html  .= '<tr>';
                    $html  .= '<th colspan="2" style="font-weight: bold;width: 9%">LM 1</th>';
                    $html  .= '<th colspan="2" style="font-weight: bold;width: 9%">LM 2</th>';
                    $html  .= '<th colspan="2" style="font-weight: bold;width: 9%">LM 3</th>';
                    $html  .= '<th colspan="2" style="font-weight: bold;width: 9%">LM 4</th>';
                    $html  .= '</tr>';
                    $html  .= '<tr>';
                    $html  .= '<th style="font-weight: bold; width: 4.5%">TP1</th>';
                    $html  .= '<th style="font-weight: bold; width: 4.5%">TP2</th>';                   
                    $html  .= '<th style="font-weight: bold; width: 4.5%">TP1</th>';
                    $html  .= '<th style="font-weight: bold; width: 4.5%">TP2</th>';
                    $html  .= '<th style="font-weight: bold; width: 4.5%">TP1</th>';
                    $html  .= '<th style="font-weight: bold; width: 4.5%">TP2</th>';
                    $html  .= '<th style="font-weight: bold; width: 4.5%">TP1</th>';
                    $html  .= '<th style="font-weight: bold; width: 4.5%">TP2</th>';
                    $html  .= '<th style="font-weight: bold; width: 4.5%">LM1</th>';
                    $html  .= '<th style="font-weight: bold; width: 4.5%">LM2</th>';
                    $html  .= '<th style="font-weight: bold; width: 4.5%">LM3</th>';
                    $html  .= '<th style="font-weight: bold; width: 4.5%">LM4</th>';
                    $html  .= '<th style="font-weight: bold; width: 5.5%">STS</th>';
                    $html  .= '<th style="font-weight: bold; width: 5.5%">SAS</th>';
                    $html  .= '</tr>';
                    ...
                    while ($row = mysqli_fetch_array($query)) {
                        ...
                        $html  .= '<tr>';
                        $html  .= '<td style="width: 4%">' . $i++ . '</td>';
                        $html  .= '<td style="text-align: left; width: 22%">' . $mapel . '</td>';
                        $html  .= '<td style="width: 4.5%">' . $LM1_TP1 . '</td>';
                        $html  .= '<td style="width: 4.5%">' . $LM1_TP2 . '</td>';
                        $html  .= '<td style="width: 4.5%">' . $LM2_TP1 . '</td>';
                        $html  .= '<td style="width: 4.5%">' . $LM2_TP2 . '</td>';
                        $html  .= '<td style="width: 4.5%">' . $LM3_TP1 . '</td>';
                        $html  .= '<td style="width: 4.5%">' . $LM3_TP2 . '</td>';
                        $html  .= '<td style="width: 4.5%">' . $LM4_TP1 . '</td>';
                        $html  .= '<td style="width: 4.5%">' . $LM4_TP2 . '</td>';
                        $html  .= '<td style="width: 4.5%">' . $LM1 . '</td>';
                        $html  .= '<td style="width: 4.5%">' . $LM2 . '</td>';
                        $html  .= '<td style="width: 4.5%">' . $LM3 . '</td>';
                        $html  .= '<td style="width: 4.5%">' . $LM4 . '</td>';
                        $html  .= '<td style="width: 5.5%">' . $STS . '</td>';
                        $html  .= '<td style="width: 5.5%">' . $SAS . '</td>';
                        $html  .= '</tr>';
                    }
                    $html  .= '</table>';
                    $html  .= '</div>';
                    ...
                    $html  .= '<table border="0.75" style="text-align: center; font-family: helvetica; font-size: 11px;">';
                    $html  .= '<tr>';
                    ...
                    $html  .= '</table><br><br>';
                    //Catatan
                    $html  .= '<table style="text-align: center; font-family: helvetica; font-size: 11px;">'; 
                    $html  .= '<tr>';
                    ...
                    while ($rowCatatan = mysqli_fetch_array($catatanSiswa)) {
                        ...
                        $html  .= '<td  border="0.75" style="line-height: 2; font-style: italic; width: 80%">"' . $catatan . '"</td>';
                        $html  .= '<td style="width: 10%"></td>';
                    }
                    $html  .= '</tr>';
                    $html  .= '</table>';
                    ...
                    if ($semester == 'Genap'){
                        ...
                        $html  .= '<tr>';
                        $html .= '<td style="width: 10%;"></td>';
                        $html .= '<td  border="0.75" style="line-height: 1.5; font-weight: normal; width: 80%">Berdasarkan penilaian hasil belajar, siswa dinyatakan :';                    
                        $html .= '</td>';
                        $html .= '<td style="width: 10%;"></td>';                    
                        $html  .= '</tr>';
                        $html  .= '<tr>';
                        ...
                        while ($rowKenaikan = mysqli_fetch_array($kenaikanSiswa)){
                            ...
                            $html  .= '<td  border="0.75" style="line-height: 3; font-style: italic; width: 80%">' . $tampilKenaikan . '</td>';
                            $html  .= '<td style="width: 10%"></td>';
                            $html  .= '</tr>';
                            $html  .= '</table>';
                            $html  .= '</td>';
                    ...
                    $html .= '<table style="font-family: helvetica; font-size: 11px;">';
                    $html .= '<tr>';
