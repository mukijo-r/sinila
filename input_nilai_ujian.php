...
<html lang="en">
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">PROSES / Input Data / Nilai Ujian</li>                            
                        </ol>                        
                        <br>
                        <div class="container-fluid px-4">
                            <div class="row">
                                <div class="col-md-2">
                                    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalTambahNilaiUjian">
                                        Input Nilai
                                    </button>
                                </div>
                                <div class="col-md-2">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php 
                                    $dataNilaiUjian = mysqli_query($conn, "SELECT
                                    nu.*,
                                    ...
                                    m.mapel as mapel
                                    FROM nilai_ujian nu
                                    LEFT JOIN tahun_ajar ta ON nu.id_tahun_ajar = ta.id_tahun_ajar
                                    LEFT JOIN siswa s ON nu.id_siswa = s.id_siswa
                                    LEFT JOIN mapel m ON nu.id_mapel = m.id_mapel
                                    WHERE id_kelas = $kelas
                                    AND nu.id_tahun_ajar = '$idTahunAjar'
                                    ORDER BY nu.id_nu DESC;");

                                    $totalEntries = mysqli_num_rows($dataNilaiUjian);
                                    $i = $totalEntries;
                                    
                                    while($data=mysqli_fetch_array($dataNilaiUjian)){
                                        $idNilaiUjian = $data['id_nu'];                                       
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$guruPenilai;?></td>
                                            <td>
                                                <button type="button" class="btn btn-warning" name="tblEdit" data-bs-toggle="modal" data-bs-target="#modalEditNilaiSiswa<?=$idNilaiUjian;?>">Edit</button>
                                                <button type="button" class="btn btn-danger" name="hapusNilaiMapel" data-bs-toggle="modal" data-bs-target="#modalHapusNilaiSiswa<?=$idNilaiUjian;?>">Hapus</button> 
                                            </td>
                                        </tr>
                                        <!-- Modal edit Nilai Ujian Siswa -->
                                        <div class="modal fade" id="modalEditNilaiSiswa<?=$idNilaiUjian;?>">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <!-- Modal Header -->
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Edit Nilai Ujian Siswa</h4>
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <div class="modal-footer">
                                                            <input type="hidden" name="idNilaiUjian" value="<?=$idNilaiUjian;?>">
                                                            <input type="hidden" name="namaUser" value="<?=$namaUser;?>">
                                                            <button type="submit" class="btn btn-primary" name="ubahNilaiUjian">Simpan</button>
                                                        </div><br>
                                                    </form>
                                                </div>
                                            </div>
                                    ...
                                    <!-- Modal Hapus Nilai Ujian Siswa-->
                                    <div class="modal fade" id="modalHapusNilaiSiswa<?=$idNilaiUjian;?>">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <input type="hidden" name="idNilaiUjian" value="<?=$idNilaiUjian;?>">
                                                <button type="submit" class="btn btn-danger" name="hapusNilaiUjian">Hapus</button> 
                                            </div>
                                            <br> 
                                            </form>       
                                            </div>
    ...
    <div class="modal fade bd-example-modal-lg" id="modalTambahNilaiUjian" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title">Tambah Nilai Ujian Siswa kelas <?=$kelas;?></h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <!-- Modal Body -->
                <form method="post">
