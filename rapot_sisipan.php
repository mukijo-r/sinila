        ...
        <div id="layoutSidenav" class="layoutSidenav">
            ...
            <div id="layoutSidenav_content" class="layoutSidenav_content">
                                    ...
                                    <div class="col">
                                        <div class="input-group mb-3">
                                            ...
                                            <select class="form-select" name="siswa" id="siswa" aria-label="siswa" required>
                                                ...
                                                <?php
                                                // Ambil data siswa
                                                $querySiswa = mysqli_query($conn, "SELECT DISTINCT nu.id_siswa, s.nama 
                                                FROM `nilai_ujian` nu 
                ...
                function tabelDaftarNilai($idTahunAjar, $semester, $kelas, $idSiswa, $nomorUrut, $tanggalCetak) {
                    ...
                    echo '<th rowspan="2" colspan="2" style="text-align: center; vertical-align: middle;">NSLM</th>';
                    echo '<th rowspan="2" style="vertical-align: middle;">NS</th>';
                    echo '</tr>';
                    echo '<tr>';
