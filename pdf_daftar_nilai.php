...
$html .= '<th rowspan="3" style="font-weight: bold;line-height: 5; width: 7%">NISN</th>';
$html .= '<th rowspan="3" style="font-weight: bold;line-height: 5; width: 13%">Nama</th>';
$html .= '<th colspan="16" style="font-weight: bold;width: 48%">FORMATIF</th>';
$html .= '<th rowspan="2" colspan="5" style="font-weight: bold;width: 15.5%">NILAI SUMATIF LINGKUP MATERI</th>';
$html .= '<th rowspan="2" colspan="2" style="font-weight: bold;width: 6%">NILAI SUMATIF</th>';
$html .= '<th rowspan="3" style="font-weight: bold;line-height: 5; width: 4%">NR</th>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th colspan="4" style="font-weight: bold;width: 12%">Lingkup Materi 1</th>';
$html .= '<th colspan="4" style="font-weight: bold;width: 12%">Lingkup Materi 2</th>';
$html .= '<th colspan="4" style="font-weight: bold;width: 12%">Lingkup Materi 3</th>';
$html .= '<th colspan="4" style="font-weight: bold;width: 12%">Lingkup Materi 4</th>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th style="font-weight: bold;width: 3%">TP1</th>';
$html .= '<th style="font-weight: bold;width: 3%">TP2</th>';
$html .= '<th style="font-weight: bold;width: 3%">TP3</th>';
$html .= '<th style="font-weight: bold;width: 3%">TP4</th>';
$html .= '<th style="font-weight: bold;width: 3%">TP1</th>';
$html .= '<th style="font-weight: bold;width: 3%">TP2</th>';
$html .= '<th style="font-weight: bold;width: 3%">TP3</th>';
$html .= '<th style="font-weight: bold;width: 3%">TP4</th>';
...
$html .= '<th style="font-weight: bold;width: 3%">TP3</th>';
$html .= '<th style="font-weight: bold;width: 3%">TP4</th>';
$html .= '<th style="font-weight: bold;width: 3%">LM1</th>';
$html .= '<th style="font-weight: bold;width: 3%">LM2</th>';
$html .= '<th style="font-weight: bold;width: 3%">LM3</th>';
$html .= '<th style="font-weight: bold;width: 3%">LM4</th>';
$html .= '<th style="font-weight: bold;width: 3.5%">RATA</th>';
$html .= '<th style="font-weight: bold;width: 3%">STS</th>';
$html .= '<th style="font-weight: bold;width: 3%">SAS</th>';
$html .= '</tr>'; 
