            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="input_nilai_catatan.php">Catatan Siswa</a>
                        </li>
                        <li class="nav-item">                            
                            <a class="nav-link active" aria-current="page" href="#">Catatan Ekstrakurikuler</a>
                        </li>
                        </ul>
                        <br><br>
                        <div class="container-fluid px-4">
                            <div class="row">                                
                                ...
                                <?php   
                                    if ($role == 'admin') {
                                        ...
                                        echo '<button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#modalTambahEkstra">+ Kategori Baru</button>';
                                    } 
                                ?>
                                </div>
                            </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php 
                                    $dataNilaiCatatanEkstra = mysqli_query($conn, "SELECT
                                    nce.*,
                                    ...
                                    LEFT JOIN tahun_ajar ta ON nce.id_tahun_ajar = ta.id_tahun_ajar
                                    LEFT JOIN siswa s ON nce.id_siswa = s.id_siswa
                                    LEFT JOIN ekstrakurikuler ek ON nce.id_ek = ek.id_ek
                                    WHERE id_kelas = $kelas
                                    AND nce.id_tahun_ajar = '$idTahunAjar'
                                    ORDER BY nce.id_nce DESC;");

                                    $totalEntries = mysqli_num_rows($dataNilaiCatatanEkstra);
                                    $i = $totalEntries;
                                    
                                    while($data=mysqli_fetch_array($dataNilaiCatatanEkstra)){
                                        $idNilaiCatatan = $data['id_nce'];                                       
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Ubah Nilai Catatan Ekstrakurikuler Siswa kelas <?=$kelas;?></h4>
                                                    ...
                                                    <form method="post">
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="ekstra">Ekstrakurikuler :</label><br>
                                                                <select class="form-select" name="ekstra" id="ekstra" aria-label="Ekstra" required>
                                                                    <option value="<?=$idEkstra;?>"><?=$ekstra;?></option>                            
                                                                    <?php
                                                                    $queryEkstra = mysqli_query($conn, "SELECT `id_ek`, `nama_ek` FROM `ekstrakurikuler`");
                                                                    while ($rowEkstra = mysqli_fetch_assoc($queryEkstra)) {
                                                                        echo '<option value="' . $rowEkstra['id_ek'] . '">' . $rowEkstra['nama_ek'] . '</option>';
                                                                    }
                                                                    ?>
                                                                </select>
                                                            </div>      
                                                            ...
                                                            <div class="text-center">
                                                                ...
                                                                <button type="submit" class="btn btn-primary" name="ubahNilaiCatatanEkstra">Simpan</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <form method="post">
                                                    ...
                                                    <div class="modal-footer">
                                                        <input type="hidden" name="idCatatanEkstra" value="<?=$idNilaiCatatan;?>">
                                                        <button type="submit" class="btn btn-danger" name="hapusCatatanEkstra">Hapus</button> 
                                                    </div>
                                                    <br> 
                                                </form>       
                                            </div>
            ...
            <div class="modal-content">
                ...
                <form method="post">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            if (mysqli_num_rows($querySiswa) > 0) {
                                ...
                                while ($rowSiswa = mysqli_fetch_assoc($querySiswa)) {
                                    ...
                                    echo '<input type="text" name="nilai_' . $rowSiswa['id_siswa'] . '" class="form-control" required>';
                                    echo '</div>';
                        ...
                        <div class="text-center">
                        <input type="hidden" name="namaUser" value="<?=$namaUser;?>">
                            <button type="submit" class="btn btn-primary" name="tambahCatatanEkstra">Simpan</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="modal fade" id="modalTambahEkstra">
        <div class="modal-dialog">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title">Tambah Kategori Ekstrakurikuler</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <!-- Modal Body -->
                <form method="post">
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="ekstra">Nama Ekstrakurikuler :</label><br>
                            <input type="text" name="ekstra" class="form-control" required>
                        </div>
                        <div class="text-center">
                            <button type="submit" class="btn btn-primary" name="tambahEkstrakurikuler">Simpan</button>
                        </div>
                    </div>
                </form>
            </div>
